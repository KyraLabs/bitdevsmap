  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-[rgba(6,6,7,0.82)] backdrop-blur-[8px]">
      <div className="wrap flex h-16 items-center justify-between">
        <a className="flex items-center gap-[11px] no-underline" href="#mapa">
          <span
            aria-hidden
            className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-kyra-orange shadow-[0_1px_6px_rgba(0,0,0,0.4)]"
          >
            <span className="rotate-12 font-sans text-[15px] font-bold leading-none text-white">
              ₿
            </span>
          </span>
        ...
        <nav className="flex items-center gap-[26px]">
          <a className={`${navLink} text-muted hover:text-strong max-[680px]:hidden`} href="#mapa">
            Map
          </a>
          <a
